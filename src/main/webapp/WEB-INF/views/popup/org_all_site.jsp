...
<script type="text/javascript">
	...
	function searchUser(){
		...
		var searchType = $("#search-user-type").val();
		...
		var postData = { rim_search_id : "empNm" , rim_search_text : text , rim_search_type : searchType};
...
<body>
	<section class="content">
			...
			<div class='col-xs-6'>
				<div class="box box-primary rim-box-users no-padding JSTable box-popup-top-right">
					<div class="box-header with-border">
						...
						<div class="pull-right">
							<div class="input-group input-group-xs">
								<select class="form-control" id="search-user-type" style="width:45%;">
									<option value="name" selected><spring:message code='label.user.name' /></option>
									<option value="email"><spring:message code='label.email' /></option>
								</select>
								<input type="text" class="form-control input-search-user" style="width:55%;"> <span class="input-group-btn">
		...
		<div class="row text-center row-popup-command">
