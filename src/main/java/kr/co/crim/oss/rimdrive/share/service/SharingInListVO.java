...
public class SharingInListVO {
    ...
    public String getShareStorageId() {
	return shareStorageId;
    }

    public void setShareStorageId(String shareStorageId) {
	this.shareStorageId = shareStorageId;
    }
    ...
    public String getShareUserNm() {
        return shareUserNm;
    }

    public void setShareUserNm(String shareUserNm) {
        this.shareUserNm = shareUserNm;
    }
